/*
 * mm2_1.c - explicit double linked list(free blocks) + first-fit malloc package.
 *	free block sort according to LIFO, which means always put the free block in front of the linked list, which could be finished in constant time
 */
#include <stdio.h>
#include <stdlib.h>
#include <assert.h>
